    ...
    <div className="hc-ul__page">
      ...
      <aside className="hc-ul__sidebar">
        ...
        <div className="hc-ul__profile">
          <div className="hc-ul__avatar">{user.name?.charAt(0).toUpperCase()}</div>
        ...
        <nav className="hc-ul__nav">
          ...
          {menuItems.slice(0, 2).map((item) => (
            <Link key={item.path} to={item.path}
              ...
              {location.pathname === item.path && <span className="hc-ul__nav-active-dot" />}
            </Link>
          ))}
      ...
      <div className="hc-ul__main">
        <header className="hc-ul__topbar">
          ...
          <div className="hc-ul__topbar-right">
            <Link to="/find-a-doctor" className="hc-ul__topbar-book">+ Book Appointment</Link>
            <div className="hc-ul__topbar-avatar">{user.name?.charAt(0).toUpperCase()}</div>
          </div>
        </header>
