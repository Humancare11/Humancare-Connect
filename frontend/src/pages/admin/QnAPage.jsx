    ...
    <div className="qna-page">
      ...
      <div className="qna-list">
        ...
        {filtered.map((q, i) => {
          ...
          const showSuccess = successId   === q.id;
            ...
            >
              ...
              <div className="qna-card-top">
                ...
                <div className="qna-card-right">
                  <span className="qna-date"><IconCal /> {formatDate(q.date)}</span>
                  <span className="qna-q-id">#{q.id}</span>
                </div>
              </div>
              ...
              {isAnswering && (
                <AnswerForm
                  question={q}
                  onSubmit={(ans, name, spec) => handleSubmitAnswer(q.id, ans, name, spec)}
